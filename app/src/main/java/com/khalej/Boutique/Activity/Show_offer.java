        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        startActivity(new Intent(Show_offer.this,MainActivity.class));
                        finish();
                    }
                }
        );
...
//             realm.delete(subject_content_realm.class);
        ...
        AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Show_offer.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_cart: {
                // Do something
                startActivity(new Intent(Show_offer.this,Order_Details.class));
                return true;
            }
        }
    ...
    public void fetchInfo_annonce(){
        ...
        Call<List<contact_annonce>> call = apiinterface.getcontacts_Image_offer(id);
        call.enqueue(new Callback<List<contact_annonce>>() {
            ...
            public void onResponse(Call<List<contact_annonce>> call, Response<List<contact_annonce>> response) {
                ...
                try{
                    recyclerAdapter_annonce=new RecyclerAdapter_first_annonce_(Show_offer.this,contactList_annonce,recyclerView2);
